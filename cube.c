...
/*   Updated: 2023/06/01 17:27:32 by mstiedl          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	vars->data->pos_x = get_pos(); //dracsis making, put together
	vars->data->pos_y = get_pos(); //dracsis making, put together
	vars->data->dir_x = get_dir();
	vars->data->dir_x = get_dir(); // make based on NESW 
	vars->data->plane_x = 0;
